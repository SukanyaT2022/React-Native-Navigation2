  ...
  return (
    <View><Text>LoginScreen</Text>
     ...
     <TextInput style={styles.inputBox}  placeholder="Your Email" onChangeText={(anothertext)=>setEmail(anothertext)} value={email}/>
       <TextInput style={styles.inputBox}  placeholder="Password" onChangeText={(anothertext)=>setPassword(anothertext)} value={password} secureTextEntry={securePassword}/>
        
       <Icon name={securePassword? "eye-off" : "eye"} size={30} color="black" onPress={()=>setSecurePassword(!securePassword)}/>
